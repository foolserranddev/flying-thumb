...
try {
    ...
    $manifest = [ordered]@{
        ...
        notes = "Open a selected drive's settings page over its normal network connection and allow authorized Wi-Fi, name, and management-key changes without first resetting the drive."
    }
