...
try {
    ...
    $manifest = [ordered]@{
        ...
        notes = "Move file actions directly above the file list, add confirmed Delete, make Sync honor checked files or all files when none are checked, and add a toggle-all header checkbox."
    }
