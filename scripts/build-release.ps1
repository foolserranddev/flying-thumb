...
try {
    ...
    $manifest = [ordered]@{
        ...
        notes = "Enable the T-Dongle-S3's 8 MB OPI PSRAM so WPS has the working memory it requires, and log firmware and memory details during startup and WPS pairing."
    }
